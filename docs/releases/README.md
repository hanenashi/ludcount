# Ludcount Release History

This archive preserves verified deployment and implementation history in
...
## 2026-08-01 — Category pie charts
...
## 2026-08-01 — Shared periods and graphs
...
## 2026-08-01 — Display-symbol preference
...
## 2026-08-01 — Japanese and custom-category release
...
## 2026-07-29 — Invitation and public-demo hardening
...
## 2026-07-29 — First production release
...
The following sections preserve the original phase handoff notes. Claims about
deployment reflect their state at the time and are superseded by the dated
release entries above.
...
### Firebase Console and production status after release
